<template>
  <div :class="`arrow ${direction}`" @click="arrowClick(direction)">
    <span :class="`svg svg-arrow-${direction}`">
      <svg enable-background="new 0 0 14 26" height="26px" id="svg4-Layer_1" version="1.1" viewBox="0 0 14 26" width="14px" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" y="0px">
        <path v-if="direction == 'prev'"
