  ...
  <main class="main-content">
    <section class="slideshow">
      <div class="slideshow-inner">
        <div class="slides">
          <Slide v-for="(slide, index) in slides" :isActive="index == 0" :image="slide.image" :name="slide.name"
            :desc="slide.texts[userLanguage].descText" :btnText="slide.texts[userLanguage].buttonText"
            :btnAction="slide.btnAction" />

          <div class="pagination">
            <div class="pagination2">
              <div v-for="(slide, index) in slides" :class="`item ${index == 0 ? 'is-active' : ''}`"
